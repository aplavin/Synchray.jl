...
magnetic_field(obj::UniformSynchrotronSphere{<:Any,<:Any,<:Any,<:Any,<:Number}, x4) = FullyTangled(obj.B0)
magnetic_field(obj::UniformSynchrotronSphere{<:Any,<:Any,<:Any,<:Any,<:SVector{3}}, x4) = obj.B0
emissivity_absorption(obj::UniformSynchrotronSphere, x4, k′) =
	_synchrotron_coeffs(obj.electrons, obj.ne0, magnetic_field(obj, x4), k′)
emissivity_absorption_polarized(obj::UniformSynchrotronSphere, x4, k′) = begin
	field = magnetic_field(obj, x4)
	(jI, αI) = _synchrotron_coeffs(obj.electrons, obj.ne0, field, k′)
	(j, α) = _emissivity_absorption_polarized_field(obj.electrons, jI, αI, field, k′)
	return (j, α, field)
end
